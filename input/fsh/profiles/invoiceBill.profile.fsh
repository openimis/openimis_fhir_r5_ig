...
* status from InvoiceStatusVS (required)
  * ^short = "FHIR Bill Status"
  * ^definition = "Bill status reported to FHIR Invoice required statuses."
...
* participant 0..0
* issuer 0..1 // openIMIS is issuing this bill
