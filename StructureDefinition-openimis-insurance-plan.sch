...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:InsurancePlan">
      <sch:assert test="count(f:extension[@url = 'https://github.com/openimis/openimis_fhir_r5_ig/StructureDefinition/insurance-plan-conversion']) &lt;= 1">extension with URL = 'https://github.com/openimis/openimis_fhir_r5_ig/StructureDefinition/insurance-plan-conversion': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://github.com/openimis/openimis_fhir_r5_ig/StructureDefinition/insurance-plan-max-installments']) &gt;= 1">extension with URL = 'https://github.com/openimis/openimis_fhir_r5_ig/StructureDefinition/insurance-plan-max-installments': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://github.com/openimis/openimis_fhir_r5_ig/StructureDefinition/insurance-plan-max-installments']) &lt;= 1">extension with URL = 'https://github.com/openimis/openimis_fhir_r5_ig/StructureDefinition/insurance-plan-max-installments': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://github.com/openimis/openimis_fhir_r5_ig/StructureDefinition/insurance-plan-start-cycle']) &lt;= 4">extension with URL = 'https://github.com/openimis/openimis_fhir_r5_ig/StructureDefinition/insurance-plan-start-cycle': maximum cardinality of 'extension' is 4</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:InsurancePlan/f:coverage/f:benefit/f:limit/f:value</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:InsurancePlan/f:coverage/f:benefit/f:limit/f:code</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:InsurancePlan/f:coverage/f:benefit/f:limit/f:code/f:coding</sch:title>
    <sch:rule context="f:InsurancePlan/f:coverage/f:benefit/f:limit/f:code/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>
      <sch:assert test="count(f:version) &lt;= 1">version: maximum cardinality of 'version' is 1</sch:assert>
      <sch:assert test="count(f:code) &gt;= 1">code: minimum cardinality of 'code' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:InsurancePlan/f:plan/f:generalCost/f:type</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:InsurancePlan/f:plan/f:generalCost/f:type/f:coding</sch:title>
    <sch:rule context="f:InsurancePlan/f:plan/f:generalCost/f:type/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>
      <sch:assert test="count(f:version) &lt;= 1">version: maximum cardinality of 'version' is 1</sch:assert>
      <sch:assert test="count(f:code) &gt;= 1">code: minimum cardinality of 'code' is 1</sch:assert>
